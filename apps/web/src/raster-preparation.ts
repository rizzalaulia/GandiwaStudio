...
export async function prepareRasterForSubmission(input: Input, dependencies: RasterPreparationDependencies): Promise<Readonly<{ manifest: ProjectManifest; preparation: PreparationRecord }>> {
  ...
  return { manifest: next, preparation }
}
